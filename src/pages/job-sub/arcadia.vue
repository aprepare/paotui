...
const jobs = ref([
  { id: 1, title: '物业前台接待', company: '阿尔卡迪亚物业', location: '阿尔卡迪亚服务中心', time: '工作日 08:30-17:30', pay: '¥130/天', emoji: '🏢', bg: 'linear-gradient(135deg, #4facfe, #00f2fe)', hot: true, tag: '物业' },
  { id: 2, title: '社区巡逻协管', company: '阿尔卡迪亚安保', location: '阿尔卡迪亚社区', time: '排班制', pay: '¥140/天', emoji: '🛡️', bg: 'linear-gradient(135deg, #667eea, #764ba2)', hot: false, tag: '物业' },
  { id: 3, title: '绿化养护助理', company: '阿尔卡迪亚物业', location: '社区花园', time: '早班 07:00-12:00', pay: '¥100/半天', emoji: '🌿', bg: 'linear-gradient(135deg, #43e97b, #38f9d7)', hot: false, tag: '物业' },
  { id: 4, title: '超市收银员', company: '社区超市', location: '阿尔卡迪亚商业街', time: '排班制', pay: '¥18/小时', emoji: '💰', bg: 'linear-gradient(135deg, #ffecd2, #fcb69f)', hot: true, tag: '商超' },
  { id: 5, title: '便利店店员', company: '全家便利店', location: '阿尔卡迪亚北门', time: '晚班 18:00-23:00', pay: '¥16/小时', emoji: '🏪', bg: 'linear-gradient(135deg, #89f7fe, #66a6ff)', hot: false, tag: '商超' },
  { id: 6, title: '水果店理货', company: '百果园', location: '阿尔卡迪亚商业区', time: '上午 08:00-12:00', pay: '¥15/小时', emoji: '🍎', bg: 'linear-gradient(135deg, #fa709a, #fee140)', hot: false, tag: '商超' },
  { id: 7, title: '快餐店服务员', company: '社区餐饮', location: '阿尔卡迪亚美食街', time: '午/晚餐时段', pay: '¥20/小时', emoji: '🍔', bg: 'linear-gradient(135deg, #f093fb, #f5576c)', hot: false, tag: '餐饮' },
  { id: 8, title: '奶茶店兼职', company: '蜜雪冰城', location: '阿尔卡迪亚南门', time: '排班制', pay: '¥16/小时', emoji: '🧋', bg: 'linear-gradient(135deg, #a18cd1, #fbc2eb)', hot: true, tag: '餐饮' },
  { id: 9, title: '托管班辅导老师', company: '社区教育中心', location: '阿尔卡迪亚教育楼', time: '周一至周五 15:30-18:30', pay: '¥80/次', emoji: '📝', bg: 'linear-gradient(135deg, #a1c4fd, #c2e9fb)', hot: true, tag: '教育' },
  { id: 10, title: '少儿美术助教', company: '创意美术工作室', location: '阿尔卡迪亚二期', time: '周末 09:00-12:00', pay: '¥100/次', emoji: '🎨', bg: 'linear-gradient(135deg, #fbc2eb, #a6c1ee)', hot: false, tag: '教育' },
  { id: 11, title: '社区运动会志愿者', company: '阿尔卡迪亚居委会', location: '社区广场', time: '活动期间', pay: '¥120/天', emoji: '🏅', bg: 'linear-gradient(135deg, #f5576c, #ff6a88)', hot: false, tag: '活动' },
  { id: 12, title: '快递代收点', company: '菜鸟驿站', location: '阿尔卡迪亚东门', time: '每天 10:00-20:00 排班', pay: '¥15/小时', emoji: '📦', bg: 'linear-gradient(135deg, #fddb92, #d1fdff)', hot: false, tag: '其他' }
])
